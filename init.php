<?php
//  -------------------- CONNEXION BDD ------------------------------- //
$bdd = new PDO('mysql:host=localhost;dbname=pokemon', 'root', '', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_WARNING, PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8'));

// -------------- SESSION ---------------- //
session_start();

// -------------- CHEMIN ------------- //
define("RACINE_SITE",$_SERVER['DOCUMENT_ROOT']."/PHP/pokemon/");
//echo RACINE_SITE;
...
define("URL", "http://localhost/PHP/pokemon/");
// echo URL;
